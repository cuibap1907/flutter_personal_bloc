              ...
              child: StreamBuilder<bool>(
                ...
                builder: (context, snapshot) {
                  return TextField(
                    ...
                    decoration: InputDecoration(labelText: "Input User Name", 
                    errorText: snapshot.data == true ? null: "invalid user name.",
                ...
                builder: (context, snapshot) {
                  return TextField(
                    ...
                    decoration: InputDecoration(
                      errorText: snapshot.data == true? null: "invalid password.",
